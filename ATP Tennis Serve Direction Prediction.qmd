...
# Split data into train/test and evaluate models for serve direction prediction

Split Data into train/test and evaluate ML models
```{r}
...
run_analysis <- function(points_data, top_n_players = 10, min_matches = 60) {
    ...
    create_results_table <- function(results_list) {
        ...
        colnames(df) <- c("Player", "LR", "RF", "DT", "SVM", "NN", "MEAN")
